using POS_System_Project.Helper;
using POS_System_Project.Models;
using System;
...
namespace POS_System_Project.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            POS_SystemEntities db = new POS_SystemEntities();
        ...
        {
            POS_System_Project.Helper.AppHelper.ReturnMessage retMessage = new AppHelper.ReturnMessage();
            POS_SystemEntities db = new POS_SystemEntities();
        ...
        [HttpGet]
        public JsonResult GetAllProductSelect()
        {
            POS_SystemEntities db = new POS_SystemEntities();
